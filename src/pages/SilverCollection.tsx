...
import silverHero from "@/assets/silver-collection.jpg";
...
const SilverCollection = () => {
  ...
  useEffect(() => {
    fetchProducts(20, "tag:silver OR title:silver OR product_type:silver").then((p) => {
      setProducts(p);
      setLoading(false);
    });
  }, []);
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] flex items-end overflow-hidden">
        <div className="absolute inset-0">
          <img src={silverHero} alt="Silver Collection" className="w-full h-full object-cover" />
      ...
      <section className="py-24 px-6">
        <div className="container mx-auto">
          <p className="font-accent text-xl text-muted-foreground max-w-2xl mb-16 leading-relaxed">
            Cool-toned elegance in 925 sterling silver. Each piece is polished to capture light with crisp, modern brilliance.
          </p>
          {loading ? (
